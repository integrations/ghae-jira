...
const verifyGithubMiddleware = require('./verify-github-middleware');

const retrySync = require('./retry-sync');

const api = require('../api');
const logMiddleware = require('../middleware/log-middleware');
const postJiraConfiguration = require('./post-jira-configuration.js');
...
module.exports = (appTokenGenerator) => {
  ...
  app.get('/github/setup', csrfProtection, verifyGithubMiddleware, oauth.checkGithubAuth, getGitHubSetup);
  ...
  app.post('/jira/configuration', postJiraConfiguration)
