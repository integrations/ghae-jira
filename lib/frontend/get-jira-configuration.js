...
module.exports = async (req, res, next) => {
  try {
    ...
    res.render('jira-configuration.hbs', {
      ...
      ghaeInstance: process.env.GITHUB_INSTANCE === 'ghae' || false,
      appName: process.env.JIRA_APP_NAME,
      ghaeURL:  connections.length > 0 && new URL(connections[0].html_url).origin,
